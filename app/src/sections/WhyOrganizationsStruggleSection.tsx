...
export default function WhyOrganizationsStruggleSection() {
  ...
  return (
    <section id="why-struggle" className="w-full py-24 bg-surface-container-lowest border-y border-outline-variant/30">
      <div className="container-main max-w-4xl">
        ...
        <ScrollReveal delay={0.3}>
          <div className="bg-primary-container border-l-4 border-nebula-gold p-8">
            <p className="font-body text-body-lg text-on-surface mb-2">
              {t('struggle_amplify')}
            </p>
